  ...
  const ConfirmacionPedidoScreen = () => {
    ...
    const handleConfirmarPedido = async () => {
      ...
      try {
        ...
        const usuarioResponse = await axios.get(`http://192.168.101.6:5000/usuario/${userId}`);
        ...
        // Guardar los datos en AsyncStorage para que la pantalla de éxito los utilice
        await AsyncStorage.setItem(
          'pedido',
          JSON.stringify({ pedido, productos, datosPersonales })
        );
